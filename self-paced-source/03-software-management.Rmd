...
At the momemt, we have not used the newly build image, that follows in the next step.
...
<video class="welcome_vid" controls muted>
  <source src="https://github.com/aaronpeikert/repro-workshop/releases/latest/download/4Software.Management.mp4" type="video/mp4">
